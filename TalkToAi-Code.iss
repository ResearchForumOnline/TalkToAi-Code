...
OutputBaseFilename=TalkToAi-Code-0.2.4-Windows-Setup
Compression=lzma2
...
[Files]
Source: "dist-studio-v6\TalkToAiCode\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
